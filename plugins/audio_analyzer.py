...
class AudioAnalyzerPlugin:
    ...
    def _on_track_loaded(self, track_id: int) -> None:
        ...
        cached = self.context.database.get_audio_analysis(track_id)
    ...
    def _start_batch_analysis(self) -> None:
        ...
        tracks = self.context.database.get_all_tracks(mode=current_mode)
        ...
        def needs_analysis(track_id: int, filepath: str) -> bool:
            ...
            analysis = self.context.database.get_audio_analysis(track_id)
    ...
    def _on_batch_analysis_complete(self, item: tuple[int, str], result: dict[str, float]) -> None:
        ...
        try:
            ...
            self.context.database.save_audio_analysis(track_id, safe_data)
