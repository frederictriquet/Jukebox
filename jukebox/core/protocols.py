...
class TrackRepositoryProtocol(Protocol):
    ...
    def get_recently_played_artists_genres(self, limit: int = 20) -> list[Any]: ...
    def get_random(self, limit: int) -> list[Any]: ...
    def get_random_by_artist_unplayed(
        self, artist: str, limit: int, exclude_days: int = 7
    ) -> list[Any]: ...
    def get_random_by_genre(self, genre: str, limit: int) -> list[Any]: ...
...
class PlaylistRepositoryProtocol(Protocol):
    ...
    def get_all_with_counts(self) -> list[Any]: ...
    def delete(self, playlist_id: int) -> bool: ...
    def get_tracks(self, playlist_id: int) -> list[Any]: ...
...
class DatabaseProtocol(Protocol):
    ...
    @property
    def playlists(self) -> PlaylistRepositoryProtocol: ...
